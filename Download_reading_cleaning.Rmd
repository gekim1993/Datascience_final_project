...
1. Can the percentage of certain fast-food restaurant be related to obesity, diabetes and stroke rate in different neighborhoods of NYC ? 2. Can the percentage of health inspection grade A restaurant be related to obesity, diabetes and stroke rate in different neighborhoods of NYC? 3. Can the composite restaurant health score of each neighborhood be related to chronic disease rate?  
...
```{r do the linear regression between obesity and grade_percent for neighborhood}
...
```{r do the linear regression between diabetes and grade_percent for neighborhood}
...
```{r do the linear regression between stroke and grade_percent for neighborhood}
